  ...
  const fetchRooms = async () => {
    try {
      ...
      if (!db || typeof db !== "object") {
        console.warn("Firestore not initialized, using cached data");
  ...
  return (
    <AuthGuard allowedRoles={["student"]} requireAuth={true} requireRole={true}>
      ...
      >
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      ...
                      <div className="text-xs text-muted-foreground">
                        This room can accommodate up to {room.capacity} students
                        and is suitable for {room.roomType} activities.
                      </div>
                    </div>
                  </CardContent>
                </Card>
        ...
        <div className="text-center py-8">
          <p className="text-muted-foreground">
            Use the navigation cards above to access Events and Issue Hub. Room
            allocations are managed by faculty.
          </p>
        </div>
      </DashboardLayout>
    </AuthGuard>
